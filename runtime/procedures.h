...
// TODO: Double-check that obj is a bytecode procedure!
static inline proc_t* to_proc(oop obj) { return (proc_t*) obj.mem; }

// code is bytecode (see compiler.fn), env is a Frame.
extern proc_t* make_compiled_procedure(oop lambda_list, oop env,
...
// TODO: Better name.
extern oop make_frame_for_application(proc_t* proc, oop args, oop caller);
...
extern oop apply_compiled_lisp_procedure(proc_t* proc, oop args, oop caller);
